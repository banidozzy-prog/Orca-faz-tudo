...
const myEmojis = {
    ...
    criar: "➕", // Mantido padrão leve
    codigo: "⚙️"  // Mantido padrão leve
};
...
client.once('ready', async () => {
    ...
    try {
        ...
        console.log('⚙️ Sistema Mestre de Tickets com Emojis Novos Online!');
...
client.on('interactionCreate', async (i) => {
    ...
    if (i.isModalSubmit() && i.customId === 'modal_ticket_banner') {
        ...
        await i.reply({ content: `${myEmojis.confirmar} Imagem do painel atualizada!`, ephemeral: true });
    }
    ...
    // ==================== EXECUÇÃO DA ABERTURA DO TICKET (MARCAÇÃO DE SUPORTE) ====================
