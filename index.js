...
// =======================================================
// ⚠️ INSIRA O TOKEN DO SEU BOT ENTRE AS ASPAS ABAIXO:
const MEU_TOKEN_SEGURO = 'COLE_SEU_TOKEN_AQUI';
// =======================================================
...
const registarComandos = async (guildId) => {
    ...
    // Agora usa a variável direta, sem depender do painel da Shard
    const rest = new REST({ version: '10' }).setToken(MEU_TOKEN_SEGURO);
...
// Comando de texto para forçar o registro caso precise
...
// Autentica diretamente com o token colocado no código
client.login(MEU_TOKEN_SEGURO);
