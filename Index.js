...
const client = new Client({
    ...
    // Partials são obrigatórios para o bot ler mensagens e mídias antigas
...
async function executarConfigurar(interaction) {
    ...
    const embed = new EmbedBuilder()
        .setTitle(`${EMOJI_SINO} Configuração do Sistema de Logs`)
...
// --- EVENTO: ENTRADA DE MEMBRO (IGUAL AO SEU PRINT) ---
    ...
    try {
        ...
        if (entrouPorVanity) {
            ...
            if (inviteUsado) {
                ...
                // Frase idêntica à do print, 100% em português
